		...
		for imageIndex in range(0, len(dogSpace[0])):
			...
			for i in range(0, currentDogSpace_l):
				for j in range(0, currentDogSpace_b ):
					diff = scaleSpace[octaveIndex][imageIndex+1][i][j] - scaleSpace[octaveIndex][imageIndex][i][j]
					if (diff>=0):
						dogSpace[octaveIndex][imageIndex][i][j] = diff
					else:
						dogSpace[octaveIndex][imageIndex][i][j] = diff + 256
	for octaveIndex in range(0, len(dogSpace)):
		for imageIndex in range(0, len(dogSpace[0])):
